...
struct Room: Codable, Identifiable, Hashable {
    ...
    enum CodingKeys: String, CodingKey {
        case id, name, icon, color, remindersEnabled
...
struct Task: Codable, Identifiable, Hashable {
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try c.encodeIfPresent(reminderHour, forKey: .reminderHour)
...
struct ActivityEvent: Identifiable, Hashable {
    ...
    let resultingDueDate: Date?
    let previousLastDoneAt: Date?
    let resultingLastDoneAt: Date?
...
struct Settings: Codable, Identifiable {
    ...
    var overdueFollowUpsEnabled: Bool = false
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case defaultReminderHour, defaultReminderMinute, overdueFollowUpsEnabled
    }
}
